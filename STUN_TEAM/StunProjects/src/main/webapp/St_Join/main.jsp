            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="test_st_userJoin2.jsp">로그인</a></li>
                    ...
                    <div class="col-lg-6">
                        <div class="text-center my-5">
                            ...
                            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                                <a class="btn btn-primary btn-lg px-4 me-sm-3" href="#features">실시간 확인</a>
                                <a class="btn btn-outline-light btn-lg px-4" href="#!">예약하기</a>
                            </div>
                        </div>
                    </div>
                </div>
